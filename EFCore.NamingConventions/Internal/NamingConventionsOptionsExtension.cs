...
public class NamingConventionsOptionsExtension : IDbContextOptionsExtension
{
    ...
    public virtual NamingConventionsOptionsExtension WithCustomCaseNamingConvention(CultureInfo? culture = null)
    {
        var clone = Clone();
        clone._namingConvention = NamingConvention.CustomCase;
        clone._culture = culture;
        return clone;
    }
            ...
            get
            {
                if (_logFragment == null)
                {
                    ...
                    builder.Append(Extension._namingConvention switch
                    {
                        ...
                        NamingConvention.CustomCase => "using custom-case naming",
